/**
 * This file was heavily borrowed from Spotify's Web Api Examples
 * Repository: https://github.com/spotify/web-api-examples/blob/master/get_user_profile/src/authCodeWithPkce.ts
 * 
 * The finishing steps of redirectToAuthCodeFlow and getAccessToken were modified to work inside of the extension how I need them to.
 * 
 * The original license for this code is the Apache 2.0 License and is reproduced below:
 * 
 *                                  Apache License
...
export async function redirectToAuthCodeFlow(clientId: string, context: vscode.ExtensionContext) {
    ...
    context.secrets.store("verifier", verifier);
